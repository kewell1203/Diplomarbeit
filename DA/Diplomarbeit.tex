...
\label{sec:fv2}
\end{eqnarray}
for an appropriate initial condition. $\hat{\sigma}_{H,t} = \exp\{\hat{X}_{H,t}\}$ has following property. %As result of this, $(\hat{\sigma}_{H,t}):= \exp\{\hat{X}_{H,t}\}$ is weak stationary, we show this in following.
